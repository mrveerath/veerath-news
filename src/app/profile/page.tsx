...
export default function ProfilePage(): React.ReactElement {
  ...
  return (
    <div className="flex min-h-screen bg-zinc-950 text-zinc-100 font-inter">
      {/* Sidebar */}
      <aside className="w-72 bg-zinc-900 p-6 flex flex-col gap-6 border-r border-zinc-800 sticky top-0 h-screen">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            <h3 className="text-2xl font-bold text-zinc-100">{userDetails?.fullName}</h3>
        ...
        <div className="flex-1 flex flex-col gap-2">
          <Button
            variant="ghost"
            className={`justify-start gap-3 rounded-none ${activeTab === 'blogs' ? 'bg-zinc-800 text-red-500' : 'text-zinc-400 hover:bg-zinc-800'}`}
          ...
          <Button
            variant="ghost"
            className={`justify-start gap-3 rounded-none ${activeTab === 'assets' ? 'bg-zinc-800 text-red-500' : 'text-zinc-400 hover:bg-zinc-800'}`}
          ...
          <Button
            variant="ghost"
            className={`justify-start gap-3 rounded-none ${activeTab === 'userSetting' ? 'bg-zinc-800 text-red-500' : 'text-zinc-400 hover:bg-zinc-800'}`}
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          {activeTab === 'assets' && (
            <Button
              ...
              className="bg-red-700 text-white hover:bg-red-800 rounded-none flex gap-2"
            >
          ...
          {activeTab === 'blogs' && (
            <Button className="bg-red-700 text-white hover:bg-red-800 rounded-none flex gap-2">
            ...
            {uploadedAssets.length > 0 ? (
              uploadedAssets.map((img) => (
                ...
                >
                  ...
                  <div className="p-3">
                    <p className="text-sm text-zinc-300 truncate">{img.originalName}</p>
                    <div className="flex justify-between mt-2">
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => handleCopyUrl(img.url)}
                        className="text-zinc-400 hover:text-blue-400 rounded-none p-1"
                      ...
                      <Button
                        ...
                        className="text-zinc-400 hover:text-red-400 rounded-none p-1"
        ...
        {activeTab === 'blogs' && (
          <div className="border border-zinc-800 bg-zinc-900 rounded-none p-8 flex flex-col items-center justify-center min-h-[400px]">
            ...
            <Button className="bg-red-700 text-white hover:bg-red-800 rounded-none">
              Create Blog Post
            </Button>
          </div>
        )}
          ...
          <div className="bg-zinc-900 p-6 w-full max-w-lg border border-zinc-800 rounded-none shadow-lg">
            <div className="flex justify-between items-center mb-4">
              ...
              <Button
                ...
                variant="ghost"
                className="text-zinc-400 hover:text-zinc-100 rounded-none p-1"
            ...
            <div className="flex justify-end gap-3 mt-6">
              <Button
                onClick={() => setShowImageUploadForm(false)}
                variant="outline"
                className="border-zinc-700 text-zinc-300 hover:bg-zinc-800 rounded-none"
              >
                Cancel
              </Button>
              <Button
